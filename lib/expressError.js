...
var CWD, FS, HOME, Path, Utils, alignLeft, betterStack, env, formatHtml, formatText, getType, handleUncaughtExceptions, htmlEscape, http, injectSourceLines, isFunction;
...
injectSourceLines = function(lines, contextLinesCount) {
  var cache, codeFile, col, collectSource, err, ext, i, lineObj, linenum, matches, newLines, pushLine, re, text;
  newLines = [];
  collectSource = true;
  cache = {};
  i = 1;
...
exports.express3 = function(options) {
  var contextLinesCount, dumpException, handleUncaughtException, title, _ref, _ref1;
  if (options == null) {
    options = {};
  }
  dumpException = (_ref = options.dumpException) != null ? _ref : true;
  handleUncaughtException = (_ref1 = options.handleUncaughtException) != null ? _ref1 : false;
  ...
  return function(err, req, res, next) {
    ...
    if (env === "development" && dumpException) {
